...
class CreateTableContractCurrentStatus extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('contract_current_status', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('contract_current_status');
    }
}
